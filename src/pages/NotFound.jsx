    ...
    <div className="flex min-h-[70vh] items-center justify-center px-4 py-12">
      <Card className="max-w-xl p-10 text-center mx-auto glass">
        ...
        <Link
          ...
          className="inline-flex mt-8 items-center justify-center rounded-full bg-violet-600 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-violet-700 transition"
        >
          Return home
        </Link>
      </Card>
